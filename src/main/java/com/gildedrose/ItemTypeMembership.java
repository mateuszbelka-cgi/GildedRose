...
public class ItemTypeMembership {
     ...
     * @param   an item whose legendary status is to be determined
     ...
     * @param   an item whose conjured status is to be determined
     ...
     * @param   an item that is checked whether it is a backstage pass.
     ...
     * @param   an item that checked whether it is an Aged Brie
     ...
     * @param   an item whose quality is checked whether it is upgrading with time
     ...
     * @param   an item whose expiration status is checked
